...
const Hero = () => {
  ...
  const four = (
    <>
      <p>
        I’m a full-stack developer with experience in backend and frontend 
        web development, devops, and machine learning. 
        From crafting dynamic user interfaces to building scalable APIs and managing
